...
uses
  ...
  TRTMP.RTMP.Preview.HardwareFrame,
  TRTMP.RTMP.Server,
...
begin
  ...
  FDecoder.TrackID:=FConfig.VideoTrackID;
...
begin
  ...
  Frame.TimestampNS:=AInfo.TimestampNS;
  Frame.TimestampNanoOffset:=AInfo.TimestampNanoOffset;
