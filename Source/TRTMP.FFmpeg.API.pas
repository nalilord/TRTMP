...
type
  ...
  public
    ...
    class function LoadPacketBytes(APacket: PAVPacket; const AData: TBytes;
      ...
      AKeyframe: Boolean): Integer; overload; static;
    class function LoadPacketBytes(APacket: PAVPacket; const AData: TBytes;
      AOffset, ASize: Integer; ATimestampMS: Int64; ADurationMS: Integer;
      AKeyframe: Boolean): Integer; overload; static;
    class function LoadPacketBytes(APacket: PAVPacket; const AData: TBytes;
      AOffset, ASize: Integer; APresentationTimestampNS,
      ADecodeTimestampNS, ADurationNS: Int64;
      AKeyframe: Boolean): Integer; overload; static;
...
begin
  Result:=LoadPacketBytes(APacket, AData, AOffset, Length(AData) - AOffset,
    ATimestampMS, ADurationMS, AKeyframe);
end;

class function TRtmpFFmpegApi.LoadPacketBytes(APacket: PAVPacket;
  const AData: TBytes; AOffset, ASize: Integer; ATimestampMS: Int64;
  ADurationMS: Integer; AKeyframe: Boolean): Integer;
begin
  Result:=LoadPacketBytes(APacket, AData, AOffset, ASize,
    ATimestampMS * 1000000, ATimestampMS * 1000000,
    Int64(ADurationMS) * 1000000, AKeyframe);
end;

class function TRtmpFFmpegApi.LoadPacketBytes(APacket: PAVPacket;
  const AData: TBytes; AOffset, ASize: Integer; APresentationTimestampNS,
  ADecodeTimestampNS, ADurationNS: Int64; AKeyframe: Boolean): Integer;
var
  Buffer: PByte;
  PacketSize: Integer;
begin
  ...
  APacket^.pts:=APresentationTimestampNS;
  APacket^.dts:=ADecodeTimestampNS;
  APacket^.duration:=ADurationNS;
  APacket^.time_base.num:=1;
  APacket^.time_base.den:=1000000000;
  if AKeyframe then
